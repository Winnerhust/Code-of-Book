...
class LSMTree(object):
    ...
    def marge(self,dst_path):
        ...
        marge_bitcask = LSMTree(self.THRESHOLD,dst_path)
    ...
    def marge2(self):
        ...
        shot_num = self.curr_active
        marge_bitcask = LSMTree(self.THRESHOLD,tmp_path)
...
#    print t.get("test")
 #   print t.get("good")
  ...
  s = skiplist.SkipList(isdup=False)
  s.insert(IndexTuple(100,"good"))
  s.insert(IndexTuple(200,"xood"))
  s.insert(IndexTuple(100,"cood"))
